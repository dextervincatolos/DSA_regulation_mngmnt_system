<?php
    ...
    $getViolations = "SELECT violation_tbl.*, student_tbl.*,academic_year_tbl.*,semester_tbl.*,sanction_tbl.*,schoolpolicy_tbl.policy_title,yearlvl_tbl.year_lvl,department_tbl.dept_name,course_tbl.course_name FROM violation_tbl 
        ...
        WHERE YEARWEEK(created_at, 0) = YEARWEEK('$today', 0)";
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="weeklyViolation_tbl" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>S.Y</th>
                                <th>Semester</th>
...
include('script/datatables/weeklyViolation_tbl.php');
?>
