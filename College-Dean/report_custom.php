<?php
    ...
    $getViolations = "SELECT violation_tbl.*, student_tbl.*,academic_year_tbl.*,semester_tbl.*,sanction_tbl.*,schoolpolicy_tbl.policy_title,schoolpolicy_tbl.policy_type,yearlvl_tbl.year_lvl,department_tbl.dept_name, department_tbl.dept_desc, course_tbl.course_name,course_tbl.course_desc
        FROM violation_tbl 
        ...
        WHERE department_tbl.deptID =".$_SESSION['department'];
