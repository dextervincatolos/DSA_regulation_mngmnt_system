...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown show">
        <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="true">
            ...
            <span class="badge badge-danger navbar-badge" id="notifCount" style="display: <?php echo $notificaion == 0 ? 'none' : 'inline'; ?>"><?php echo $notificaion; ?></span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
            <div  id="notification">
            <!-- notification here -->
            </div>
            <a href="report_custom.php" class="dropdown-item dropdown-footer">See All Violation</a>
        </div>
    </li>
    ...
    <li class="nav-item dropdown user-menu">
        <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <span class="d-none d-md-inline p-2"><?php echo $_SESSION['role'].'('.$department_name.')';?> </span>
        </a>
