                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <table class="table">
                                                    <tr>
                                                        <td width="50%" style=" border: 1px solid black;">
                                                            NAME OF STUDENT: </br>
                                                            ${notification.student_fname} ${notification.student_lname} ${notification.student_extname}
                                                        </td>
                                                        <td width="50%" style=" border: 1px solid black;">
                                                            GRADE/STRAND: </br>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr class="signatories" style="border: none;">
                                                        ...
                                                        <td style=" border: none; ">${prefect.faculty_fname} ${prefect.faculty_mname || ''} ${prefect.faculty_lname} ${prefect.faculty_extname || ''}</td>
                                                        <td style=" border: none; "></td>
                                                        <td style=" border: none; ">${notification.faculty_fname} ${notification.faculty_mname} ${notification.faculty_lname} ${notification.faculty_extname}</td>
                                                        <td style=" border: none; "></td>
