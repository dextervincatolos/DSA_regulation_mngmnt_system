<script>
    ...
    $(function (){
        ...
        $("#dailyViolation_tbl").DataTable({
            "responsive": true, "lengthChange": false, "autoWidth": false,
            dom: 'Bfrtip',
            buttons: [
                {
                    extend: 'excelHtml5',
                    title: 'Daily Violation Report ' + formattedDate
                },
                {
                    extend: 'csvHtml5',
                    title: 'Daily Violation Report ' + formattedDate
                ...
                },
                {
                    ...
                    customize: function (win) {
                        $(win.document.body)
                            .css('font-size', '10pt')
                            .prepend(
                                '<div style="text-align: center; font-size: 14pt;">Daily Violation Report</div>' +
        ...
        }).buttons().container().appendTo('#dailyViolation_tbl_wrapper .col-md-6:eq(0)');
