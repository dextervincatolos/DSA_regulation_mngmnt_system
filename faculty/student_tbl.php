...
?>
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        ...
        <a href="dashboard.php" class="brand-link">
            <img src="../assets/img/cics-logo.png" alt="St. Joseph College Logo" class="brand-image img-circle elevation-3">
                ...
                <table id="student_tbl" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Male</td>
                            <td>09786192751</td>
                            <td>arvy@gmail.com</td>
                            <td>Barsat West Baggao Cagayan</td>
                            <td>Offline</td>
