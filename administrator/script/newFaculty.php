...
if(isset($_POST['submitForm']))
{
    ...
    {
        $faculty_id_exist = mysqli_query($connection, "SELECT * FROM user_tbl WHERE faculty_number = '$faculty_id' ");
        ...
        if (mysqli_num_rows($faculty_id_exist) > 0) {
            ...
            $insertRecord ="INSERT INTO user_tbl (faculty_number, faculty_fname, faculty_mname, faculty_lname, faculty_extname,faculty_role, faculty_email, Faculty_contact, deptID, faculty_password, faculty_address, login_status) 
                            VALUES ('$faculty_id', '$faculty_fname','$faculty_mname','$faculty_lname','$faculty_ename', '$faculty_role', '', '', '$department', '$enc_password', '$faculty_address', 'Offline')";
